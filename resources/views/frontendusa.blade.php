...
<body class="home page-template page-template-template-home page-template-template-home-php page page-id-1539 home-animation-complete">
    ...
    <header class="wp-top" style="opacity: 1;">
        ...
        <div class="header-bottom">
            <div class="wrap">
                <a href="/#skip-intro" class="logo logousa" title="Home Page"></a>
                <nav class="nav-main">
                    <ul>
                        <li id="menu-item-0"><a href="#">Insights</a></li>
                        <li id="menu-item-1"><a href="#">News</a></li>
                        <li id="menu-item-2"><a href="#">Partners</a></li>

                        <li class="btn"><a href="#request-a-demo">Request a Brief</a></li>
                    </ul>
                </nav>
        ...
        <div id="mobile-menu">
            ...
            <div class="m-btn-container">
                <a href="#request-a-demo">Request a Brief</a>
            </div>
        </div>
    </header>
    <!-- End Header -->
